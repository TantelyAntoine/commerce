            ...
            <div class="container">
                <div class="banner-grids">
                    <div class="col-md-6 banner-grid">
                        <h2>Tongasoa Bienvenue Welcome to Shop Tantely</h2>
                        <p>Veuillez acheter des appareils éléctronique haut de gamme(Téléphone,Ordinateur,Télévision,Décodeur etc...)</p>
                    </div>
                    <div class="col-md-6 banner-grid1">
                        <img src="<?= base_url(); ?>img/phone.jpg" class="img-responsive" alt=""/>
                    </div>
                            ...
                            <div class="col-md-3 gallery-grid ">
                                <a><img class="quicklook" id="<?= $popular->id; ?>" src="<?= base_url(); ?>/upload/product/<?= $popular->id; ?>/<?= $popular->product_image; ?>" style="height: 310px; width: 99%; cursor: pointer;" alt=""/>
                                    <div class="gallery-info quicklook" id="<?= $popular->id; ?>" style="cursor: pointer;">
                                        <div class="quick">
                                            <p><span class="glyphicon glyphicon-eye-open "  style="cursor: pointer;" aria-hidden="true"></span>Voir</p>
                                        </div>
                                    </div>
                                </a>
                                <div class="galy-info">
...
?>
        ...
        <div class="gallery">
            <div class="container">
                <h3>Les produits le plus récent</h3>
                <div class="gallery-grids">
<?php
