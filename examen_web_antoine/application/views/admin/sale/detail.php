                ...
                <div class="content content-boxed">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-3">
                            <a class="block block-link-hover3 text-center" href="javascript:void(0)">
                                ...
                                <div class="block-content block-content-full block-content-mini bg-gray-lighter text-success font-w600">Commande</div>
                            </a>
                        </div>
                        <div class="col-sm-6 col-md-3">
                            <a class="block block-link-hover3 text-center" href="javascript:void(0)">
                                ...
                                <div class="block-content block-content-full block-content-mini bg-gray-lighter text-success font-w600">Espéce paiement</div>
                            </a>
                        </div>
                        <?php
                            ...
                            if ($deliver->shipped_status == 0) {
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <a class="block block-link-hover3 text-center" href="javascript:void(0)">
                                        ...
                                        <div class="block-content block-content-full block-content-mini bg-gray-lighter text-warning font-w600">Traitement</div>
                                    </a>
                                </div>
                                <?php
                            } else {
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <a class="block block-link-hover3 text-center" href="javascript:void(0)">
                                        ...
                                        <div class="block-content block-content-full block-content-mini bg-gray-lighter text-success font-w600">Traitement</div>
                                    </a>
                                </div>
                                <?php
                            }
                            ...
                            if ($deliver->shipped_status == 0) {
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <a class="block block-link-hover3 text-center" href="javascript:void(0)">
                                        ...
                                        <div class="block-content block-content-full block-content-mini bg-gray-lighter text-success font-w600">Livraison</div>
                                    </a>
                                </div>
                    ...
                    <div class="block">
                        <div class="block-header bg-gray-lighter">
                            <h3 class="block-title">Detail du vente</h3>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-borderless table-striped table-vcenter">
                                    ...
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    foreach ($color_list as $value) {
                                                        if ($value->id == $post->color_id) {
                                                            ?>
                                                            <div style="width: 20px; height: 20px; background: #<?= $value->colorcode; ?>;"></div>
                                                            <?php
                                                        }
                                                    }
                                                    ?>
                                        ...
                                        ?>
                                        <tr>
                                            <td colspan="9" class="text-right"><strong>Prix total:</strong></td>
                                            <td>Rs. <?= $totalprice ?></td>
                                        </tr>
                                        <tr>
                                            <td colspan="9" class="text-right text-uppercase"><strong>Total a payé:</strong></td>
                    ...
                    <div class="row">
                        ...
                        foreach ($sale_address_detail as $address) {
                            ...
                            <div class="col-lg-6">
                                <div class="block">
                                    <div class="block-header bg-gray-lighter">
                                        <h3 class="block-title">Addresse de facturation</h3>
                                    </div>
                                    <div class="block-content block-content-full">
                            ...
                            <div class="col-lg-6">
                                <div class="block">
                                    <div class="block-header bg-gray-lighter">
                                        <h3 class="block-title">Adresse de transport de bien</h3>
                                    </div>
                                    <div class="block-content block-content-full">
                                        <div class="h4 push-5" style="text-transform: uppercase;"><?= $address->firstname ?>&nbsp;<?= $address->lastname ?></div>
                                        <address>
                        ...
                        foreach ($deliver_sale as $deliver) {
                            if ($deliver->shipped_status == 0) {
                                ...
                                <div class="col-lg-12" style="text-align: right;">
                                    ...
                                    <a href="<?= base_url(); ?>account/sale-status/<?= $deliver->id ?>" class="btn btn-minw btn-rounded btn-success" type="button"><i class="fa fa-check"></i>Livrer</a>
                                ...
                                ?>
                                <div class="col-lg-12" style="text-align: right;">
                                    <button class="btn btn-minw btn-rounded btn print" type="button"><i class="fa fa-check"></i>Imprimer</button>
                                </div>
                                <? }
                                }?>
                            </div>
        ...
        foreach ($sale_address_detail as $c) {
            ?>
                        '<table width="80%" border="0" cellpadding="0" cellspacing="0" >' +
                                ...
                                '<td><b>Téléphone:</b>&nbsp;<?php echo $c->phone ?><br><b>E-mail:</b>&nbsp;<?php echo $c->email ?><br><b>Date:</b>&nbsp;<?php echo $c->order_date ?></td>' +
                                '</tr>' +
                                '</table><br>' +
        <?php } ?>
        ...
        foreach ($sale_detail as $value) {
            ?>
                        '<tr>' +
                                ...
                                '<td><?php
            $net = $value->quantity * $value->product_price;
            echo $net;
