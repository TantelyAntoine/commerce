...
<html class="no-focus">
    <head>
        ...
        <title>Rapport de transport du vente</title>
                                ...
                                <div class="col-md-3">
                                    <select class="form-control" name="buyer_name" >
                                        ...
                                        foreach ($Buyer_Name as $buyer) {
                                            ?>
                                            <option value="<?= $buyer->buyer_name ?>"<?php if (@$buyer->buyer_name == @$buyername) echo "Selectionné"; ?>><?= $buyer->buyer_name ?></option>
                                        <?php } ?>

                                    </select>
                                </div>
                                <div class="col-md-2"><input id="example-datepicker1" class="js-datepicker form-control" name="start_date" data-date-format="yyyy/mm/dd" placeholder="Choisir date de debut" type="text"></div>
                                ...
                                <tbody>
                                    ...
                                    foreach ($sale_list as $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn-sm editField" href="<?= base_url(); ?>account/sale-detail/<?= $value->id ?>" data-toggle="tooltip" data-placement="top" title="" data-product_id="71" data-href="" data-type="sale_detail" data-original-title="Voir detail de vente">
