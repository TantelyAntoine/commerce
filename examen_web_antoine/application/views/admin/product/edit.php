...
<html class="no-focus">
                                    ...
                                    foreach ($products_edit as $post) {
                                        ...
                                        <form class="form-horizontal"  method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <input class="form-control" type="text" id="product_name" value="<?= $post->product_name ?>" name="product_name" placeholder="Produit" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <textarea class="form-control input-lg" id="product_description"  name="product_description" placeholder="Description" rows="4" ><?= $post->product_description ?></textarea>
    ...
    <?php
    $color_product = explode(',', $post->color_id);
    foreach ($color_list as $value) {
        $selcolor = '';
        foreach ($color_product as $id) {
            if ($id == $value->id) {
                $selcolor = "selected";
            }
        }
        ?>
                                                            <option value="<?= $value->id ?>"<?= $selcolor ?> ><?= $value->color_name ?></option>
                                                        <?php }
                                                        ?>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <label  class="col-md-2 control-label">Taille</label>
                                                <div class="col-md-7">
                                                    <select   class="form-control" name="sizeproduct[]"  multiple id="sizeproduct">
    <?php
    $size_product = explode(',', $post->size_id);
    foreach ($size_list as $value) {
        $selcolor = '';
        foreach ($size_product as $id) {
            if ($id == $value->id) {
                $selcolor = "selected";
            }
        }
        ?>
                                                            <option value="<?= $value->id ?>"<?= $selcolor ?> ><?= $value->size ?></option>
                                                        <?php }
                                                        ?>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <label  class="col-md-2 control-label">Relation de produit</label>
                                                <div class="col-md-7">
    ...
    foreach ($product_list as $re) {
        ...
        ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <select class="form-control" name="product_type" >
                                                        ...
                                                        <option  value="1" <?php if ($post->product_type == 1) {
                                                        echo "selected";
                                                    } ?>>Le plus récent</option>
                                                        <option  value="2" <?php if ($post->product_type == 2) {
                                                        echo "selected";
                                                    } ?>>Fréquenté</option>
                                                        <option  value="3" <?php if ($post->product_type == 3) {
                                                        echo "selected";
                                                    } ?>>Qualité</option>
                                            ...
                                            <hr><div style="text-align: center; font-weight: 100; font-size: 20px;">Détail de prix du produit</div><hr>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Prix unitaire(Ariary)</label>
                                                <div class="col-md-7">
                                                    <input class="form-control" type="text"  name="rate" value="<?= $post->product_price ?>" placeholder="Prix unitaire"  id="rate">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <input class="form-control quantity" type="text" id="quantity" value="<?= $post->quantity ?>" name="quantity" placeholder="Prix"  >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <input class="form-control" type="text" readonly="" value="<?= $post->gross_amount ?>" id="gross" name="gross_amount" placeholder="Montant brut"  >
                                                    <div style="margin-top: 0px; color: red;"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <input class="form-control discount" type="text" value="<?= $post->discount ?>" id="discount" name="product_discount" placeholder="Remise" >
                                                    <div style="margin-top: 0px; color: red;"><?= form_error('product_discount'); ?></div>
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Montant net<span class="text-danger"></span></label>
                                                <div class="col-md-7">
                                                    <input class="form-control" type="text" readonly="" value="<?= $post->net ?>" id="net" name="net_amount" placeholder="Montant net" >
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <div class="col-md-8 col-md-offset-2">
                                                    <button class="btn btn-sm btn-primary" name="submit" type="submit"><i class="fa fa-check"></i>Modifier</button>
                                                </div>
                                            </div>
                                        </form>
<?php } ?>
...
<script>
                                                    ...
                                                    $('#relatedproduct').multiselect({
                                                        columns: 1,
                                                        placeholder: 'Aucun séléctionnné',
                                                        search: true,
                                                        selectAll: true
                                                    });
