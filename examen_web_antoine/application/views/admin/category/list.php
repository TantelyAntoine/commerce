                    ...
                    <div class="block">
                        <div class="block-header">
                            ...
                            <span class="col-lg-6" style="text-align: right;">
                                <a class="btn btn-default btn-rounded btn-condensed btn-sm" data-toggle="tooltip" title="Ajouter un nouveau categorie" href="<?= base_url(); ?>account/category-add"><span title="Ajouter un sous catégorie"class="fa fa-plus"></span></a>
                            </span>
                        </div>
                                    ...
                                    <?php foreach ($category_list as $post) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php
                                                ...
                                                ?></td>
                                            <td>
                                                <a class="btn btn-default btn-rounded btn-condensed btn-sm" type="button" data-toggle="tooltip"  title="Modifier" href="<?= site_url('account/edit-category/' . $post->id) ?>"><i class="fa fa-pencil"></i></a>
                                                <a class="btn btn-default btn-rounded btn-condensed btn-sm" data-toggle="tooltip" title="Ajouter un sous catégorie" href="<?= site_url('account/add-subcategory/' . $post->id) ?>"><span title="Ajouter un sous catégorie"class="fa fa-plus"></span></a>
                                                <a class="btn btn-default btn-rounded btn-condensed btn-sm"  data-toggle="tooltip" title="Voir le sous catégorie" href="<?= site_url('account/view-subcategory/' . $post->id) ?>"><span title="Voir le sous catégorie"class="fa fa-eye"></span></a>
                                                ...
                                                <?php } ?>
                                                <a href="<?= base_url() . 'account/category-delete/' . $post->id ?>" data-href="" class="btn btn-danger btn-rounded btn-condensed btn-sm delete"  data-toggle="tooltip" title="Supprimer" ><span class="fa fa-times" title="supprimer"></span></a>
                                            </td>
