                    ...
                    <div class="block">
                        <div class="block-header">
                            ...
                            <span class="col-lg-6" style="text-align: right;">
                                <a class="btn btn-default btn-rounded btn-condensed btn-sm" data-toggle="tooltip" title="Ajouter un sous catégorie" href="<?= base_url(); ?>account/category-add"><span title="Ajouter un sous catégorie"class="fa fa-plus"></span></a>
                            </span>
                        </div>
                                    ...
                                    foreach ($subCategoryList as $post) {
                                        ...
                                        <tr> 
                                            ...
                                            <td style="text-transform: capitalize;">
                                                ...
                                                ?></td>
                                            <td>
                                                <a class="btn btn-default btn-rounded btn-condensed btn-sm" type="button" data-toggle="tooltip"  title="Modifier le sous catégorie" href="<?= site_url('account/edit-subcategory/' . $post->subcat_id) ?>"><i class="fa fa-pencil"></i></a> 
                                                <a href="<?= base_url() . 'account/sub-category-delete/' . $post->subcat_id ?>" data-href="" class="btn btn-danger btn-rounded btn-condensed btn-sm delete"  data-toggle="tooltip" title="Supprimer le sous catégorie" ><span class="fa fa-times" title="supprimer"></span></a>
                                            </td>
                                        </tr>
<?php } ?>
                                </tbody>
