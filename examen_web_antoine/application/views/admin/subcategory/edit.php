...
<html class="no-focus">
    <head>
        <meta charset="utf-8">
        <title>Modidier le sous catégorie</title>
                        ...
                        <div class="col-lg-12">
                            <div class="block">
                                <div class="block-header">
                                    ...
                                    <h3 class="block-title">Modifier le sous catégorie</h3>
                                </div>
                                    ...
                                    foreach ($editSubCategory as $post) {
                                        ...
                                        <form class="form-horizontal"  method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <input class="form-control" type="text" id="sub_category_name" value="<?= $post->subcategory_name; ?>" name="sub_category_name" placeholder="Sous catégorie" >
