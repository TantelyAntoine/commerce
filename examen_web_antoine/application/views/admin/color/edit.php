                        ...
                        <div class="col-lg-12">
                            <div class="block">
                                <div class="block-header">
                                    ...
                                    <h3 class="block-title">Modifier le couleur</h3>
                                </div>
                                        ...
                                        <form class="form-horizontal"  method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    ...
                                                    <input class="form-control" type="text" id="product_name" value="<?= $post->color_name; ?>" name="color_name" placeholder="Couleur" >
                                                    <div style="margin-top: 0px; color: red;"><?= form_error('color_name'); ?></div>
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Code du couleur</label>
                                                <div class="col-md-7">
