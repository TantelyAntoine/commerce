...
<html class="no-focus"> 
    <head>
        ...
        <title>Liste des diapositive</title>
                ...
                <div class="content">
                    <?php if ($this->session->flashdata('SUCCESSMSG')) { ?>
                        <div role="alert" class="alert alert-success">
                            <button data-dismiss="alert" class="close" type="button"><span aria-hidden="true">x</span><span class="sr-only">Fermer</span></button>
                    ...
                    <div class="block">
                        <div class="block-header">
                            <h3 class="block-title col-lg-6" style="text-align: left;">
                                Rapport de diapositive
                            </h3>
                            <span class="col-lg-6" style="text-align: right;">
                                <a class="btn btn-default btn-rounded btn-condensed btn-sm" data-toggle="tooltip" title="Ajouter nouveau diapositive" href="<?= base_url(); ?>account/add-slider"><span title="Ajouter nouveau diapositive"class="fa fa-plus"></span></a>
                            </span>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    if (($value->created_by) == 0) {
                                        ...
                                        ?>
                                            ...
                                            <td>
                                                <a class="btn btn-danger btn-rounded btn-condensed btn-sm" href="<?= base_url() ?>account/slider-delete/<?= $value->id ?>" data-href="" data-toggle="tooltip" title="" data-original-title="Supprimer">
                                                    <span class="fa fa-times" title="supprimer"></span>
                                                </a>
                                            </td>
                                        </tr>
<?php } ?>
