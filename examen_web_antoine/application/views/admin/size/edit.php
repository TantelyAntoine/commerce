...
<html class="no-focus">
    <head>
        <meta charset="utf-8">
        <title>Modifier le taille</title>
                        ...
                        <div class="col-lg-12">
                            <div class="block">
                                <div class="block-header">
                                    ...
                                    <h3 class="block-title">Modifier le taille</h3>
                                </div>
                                <div class="block-content block-content-full bg-gray-lighter ">
                                    <?php
                                    foreach ($editsize as $post) {
                                        ?>
                                        <form class="form-horizontal"  method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Taille</label>
                                                <div class="col-md-7">
                                                    <input class="form-control" type="hidden" id="size_id" value="<?= $post->id; ?>" name="size_id">
                                                    <input class="form-control" type="text" id="product_name" value="<?= $post->size; ?>" name="size_name" placeholder="Taille" >
