                        ...
                        <div class="col-lg-12">
                            <div class="block">
                                <div class="block-header">
                                    ...
                                    <h3 class="block-title">Nouveau taille</h3>
                                </div>
                                <div class="block-content block-content-full bg-gray-lighter ">
                                    <form class="form-horizontal"  method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <input class="form-control" type="text" id="product_name" value="<?php echo set_value('size_name'); ?>" name="size_name" placeholder="Taille" >
