                    ...
                    <div class="block">
                        <div class="block-header">
                            ...
                            <span class="col-lg-6" style="text-align: right;">
                                <a class="btn btn-default btn-rounded btn-condensed btn-sm" data-toggle="tooltip" title="Ajouter une taille" href="<?= base_url(); ?>account/size-add"><span title="Ajouter un taille"class="fa fa-plus"></span></a>
                            </span>
                        </div>
                                    ...
                                    <?php foreach ($size_list as $post) {
                                        ...
                                        <tr>
                                            ...
                                            if ($post->status == "0") {
                                                ...
                                                ?></td>
                                            <td>
                                                <a class="btn btn-default btn-rounded btn-condensed btn-sm" type="button" data-toggle="tooltip"  title="Modifier" href="<?= site_url('account/size-color/' . $post->id) ?>"><i class="fa fa-pencil"></i></a>
                                                <a href="<?= base_url() . 'account/size-delete/' . $post->id ?>" data-href="" class="btn btn-danger btn-rounded btn-condensed btn-sm delete"  data-toggle="tooltip" title="Supprimer" ><span class="fa fa-times" title="supprimer"></span></a>
                                            </td>
                                        </tr>
<?php } ?>
                                </tbody>
