...
class Product extends CI_Controller {
    ...
    public function product_add() {
        ...
        if (!empty($_POST)) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $insert_id = $this->Product_Model->product_insert($sub_category_id, $relatedproduct, $colorproduct, $sizeproduct);
    ...
    public function get_product_edit($product) {
        if (!empty($_POST)) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $this->Product_Model->ProductEdit_Update($insert_id, $mainimagefilename, $sub_category_id, $relatedproduct, $colorproduct, $sizeproduct);
                $this->session->set_flashdata('SUCCESSMSG', 'Mise a jour succes');
                redirect('account/produc-list');
            }
        } else {
            $data['size_list'] = $this->category_model->get_list_size();
    ...
    public function deleteProduct($id) {
        ...
        $this->session->set_flashdata('SUCCESSMSG', 'Supprimer');
        redirect('account/produc-list');
    }
